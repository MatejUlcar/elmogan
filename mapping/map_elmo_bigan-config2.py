...
parser.add_argument('--lang1', required=True, type=str, help='L1 embeddings, produced by scripts in context_dict')
parser.add_argument('--lang2', required=True, type=str, help='L2 embeddings, produced by scripts in context_dict')
parser.add_argument('--dictionary', required=True, type=str, help='L1-L2 dictionary, produced by scripts in context_dict')
parser.add_argument('--evaldict', required=True, type=str, help='L1-L2 evaluation dictionary, produced by scripts in context_dict')
...
parser.add_argument('--bs', required=False, type=int, default=256, help='batch size')
parser.add_argument('--lr', required=False, type=float, default=0.00002, help='learning rate')
parser.add_argument('--decay', required=False, type=float, default=0.00001, help='learning rate decay')
